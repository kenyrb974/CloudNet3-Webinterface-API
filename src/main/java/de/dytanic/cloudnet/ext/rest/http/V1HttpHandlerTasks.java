...
public final class V1HttpHandlerTasks extends HttpHandler {
  ...
  public void handlePost(String path, IHttpContext context) {
    ...
    if (!getCloudNet().getGroupConfigurationProvider().isGroupConfigurationPresent(serviceTask.getName())) {
      getCloudNet().getGroupConfigurationProvider().addGroupConfiguration(new EmptyGroupConfiguration(serviceTask.getName()));
    }
  ...
  public void handleDelete(String path, IHttpContext context) {
    ...
    if (CloudNetDriver.getInstance().getServiceTaskProvider().isServiceTaskPresent(name)) {
      ...
      if(getCloudNet().getGroupConfigurationProvider().isGroupConfigurationPresent(name)) {
        getCloudNet().getGroupConfigurationProvider().removeGroupConfiguration(name);
      }
    }
